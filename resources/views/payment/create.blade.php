...
@endif
    ...
    <form action="{{ route('payment.storeMultiple') }}" method="POST">
        @csrf
        <input type="hidden" name="reservation_ids[]" value="{{ json_encode($reservationIds) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="amount" name="a" value="{{ $totalAmount }} DH" readonly>
        </div>
