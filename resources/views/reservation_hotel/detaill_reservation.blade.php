...
@section('contents')
    ...
    @endif
        ...
        <table>
            ...
            <tr><td>Date arrivee :</td><td>{{$reservation->date_arrivee}}</td></tr>
            <tr><td>Date depart :</td><td>{{$reservation->date_depart}}</td></tr>
            <tr><td>Nombre de places :</td><td>{{$reservation->nombre_de_places}}</td></tr>
            <tr><td>Date reservation :</td><td>{{$hotel->created_at}}</td></tr>
        </table>

        <button  class="btn btn-info">  <a style="text-decoration:none; color:white;" href="{{url('/hotelsreservation.mes_reservation')}}" >Voir Touts Les Reservation</a></button>
